...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Kudos " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"kudoscrypto.org", "seed.kudoscrypto.org"},
    {"kudoscrypto.com", "seed.kudoscrypto.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"kudoscrypto.org", "tseed.kudoscrypto.org"},
    {"kudoscrypto.com", "tseed.kudoscrypto.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Kudos is probably already running."), addrBind.ToString().c_str());
        else
